...
<!--    </form>-->
<!--&lt;!&ndash;    <div class="product mt-3 " v-for="product in products">&ndash;&gt;-->
<!--&lt;!&ndash;        <img :src="'/storage/' + product.preview_image" alt="фото товару" class="img-fluid">&ndash;&gt;-->
<!--&lt;!&ndash;        <div class="name">{{ product.title }}</div>&ndash;&gt;-->
<!--&lt;!&ndash;        <div class="price">{{ product.price }}₴</div>&ndash;&gt;-->
<!--&lt;!&ndash;        <i @click.prevent="removeProduct(product.id)" class="fa-regular fa-circle-xmark destroy-basket-item"></i>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->
<!--&lt;!&ndash;    <div style="display: flex; align-items: center; margin-top: 20px;">&ndash;&gt;-->
<!--&lt;!&ndash;        <h3 style="margin-right: 10px;">До сплати:</h3>&ndash;&gt;-->
<!--&lt;!&ndash;        <h4 style="margin-left: 245px;">{{ totalCost }}₴</h4>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->
<!--&lt;!&ndash;    <a href="/checkout" style="background-color: white; color: black; border: 1px solid black; padding: 10px 20px; width: 300px; margin-left: 70px; border-radius: 10px; text-decoration: none; display: inline-block; text-align: center">Оформити</a>&ndash;&gt;-->
<!--</template>-->
